...
from point_match import final
from ridge_restoration import one2one, one2many, thinning
from one2one_adjust import one2one_candidates
import cv2
import math
import glob
import numpy as np
...
if __name__ == '__main__':
 images = '../preprocessed/'
i=0;
for img in glob.glob(images+'/*_thinned.png'):
    background, new_img = draw_whole_img(img)
