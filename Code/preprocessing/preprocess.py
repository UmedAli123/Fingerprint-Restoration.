...
import numpy as np
import glob
from add_noise import add_img_noise
...
def preprocessing_imnoise(img_dir='../FVC2004_DB1/DB1_B/', out_dir='./train_set/', noise_type=(('small', 1), ('large', 1))):
    """
    ...
    img_all = glob.glob(img_dir + '*_noise*')
...
def preprocess_general(img_path, out_dir='../preprocessed/'):
    """
...
i=0
for images in glob.glob(imges+'/*_noise*.png'):
         preprocess_general(images)
         i+=1;
